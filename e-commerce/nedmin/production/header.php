        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>Götür|Company</span></a>
            </div>
                ...
                <li><a href="hakkımızda.php"><i class="fa fa-info"></i> About Us  </a></li>
                  <li><a><i class="fa fa-cogs"></i> Settings <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="iletişim-ayar.php">Communication Settings</a></li>
                      <li><a href="api-ayar.php">API Settings</a></li>
                      <li><a href="mail-ayar.php">Mail Settings</a></li>
                      <li><a href="sosyal-ayar.php">Social Media Settings</a></li>
                    </ul>
                  </li>  
                </ul>
              </div>
